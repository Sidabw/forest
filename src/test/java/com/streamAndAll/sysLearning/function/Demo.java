package com.streamAndAll.sysLearning.function;
...
public class Demo {
	public static void main(String[] args){
		 ...
		 * */
		Function<String,String> function = (x) -> {System.out.println("处理1");return "aa";};
		//简写
		 ...
		 * */
		Predicate<String> predicate = (x) ->{return x.equals("");};
		//简写
		 ...
		 * */
		BinaryOperator<String> binaryOprator = (x,y) -> {return x+y;};
