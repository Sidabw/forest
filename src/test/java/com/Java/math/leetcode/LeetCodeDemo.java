...
//        int val = 3;
    ...
    @Test
    public void test11(){
        System.out.println(new LeetCodeDemo().orangesRotting(new int[][]{{2,1,1}, {1,1,0}, {0,1,1}}));
        System.out.println(new LeetCodeDemo().orangesRotting(new int[][]{{2,1,1}, {0,1,1}, {1,0,1}}));
        System.out.println(new LeetCodeDemo().orangesRotting(new int[][]{{0 ,2 }}));//0
        System.out.println(new LeetCodeDemo().orangesRotting(new int[][]{{0}}));//0
        System.out.println(new LeetCodeDemo().orangesRotting(new int[][]{{1}}));//-1
        System.out.println(new LeetCodeDemo().orangesRotting(new int[][]{{2}}));//0
        System.out.println(new LeetCodeDemo().orangesRotting(new int[][]{{1},{2}}));//1
        System.out.println(new LeetCodeDemo().orangesRotting(new int[][]{{2},{1}}));//1
